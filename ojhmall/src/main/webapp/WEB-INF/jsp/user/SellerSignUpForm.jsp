...
<body>
	<div class="container">
		...
		<form id="frm" class="form-signin" method="post"
			...
			<input	type="hidden" id="userTypeNum" name="userTypeNum" value="2">
			<h4>ID</h4>
			...
			<label for="inputZipCode" class="sr-only">Business Number</label> <input
				type="text" id="bizNumber" name="bizNumber" class="form-control"
				placeholder="Business Number" required>
			<h4>Account Number</h4>
			<label for="inputZipCode" class="sr-only">Account Number</label> <input
