...
public class ProductServiceImpl implements ProductService {
	...
	// 메인페이지 상품리스트 출력
	@Override
	public List<Product> initPrd(int initPrdCount) throws Exception {
		return productDAO.initPrd(initPrdCount);
	}
	// 판매자가 등록한 상품리스트 출력
	@Override
	public List<Product> loadSellerPrd(User user) throws Exception {
	...
	@Override
	public Product getPrdInfo(Product prd) throws Exception {
	...
	@Override
	public List<Product> getPrdList(int prdStatus) throws Exception {
