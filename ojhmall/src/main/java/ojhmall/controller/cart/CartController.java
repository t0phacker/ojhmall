...
public class CartController {
    ...
    public ModelAndView showCart(@RequestParam(value="userNumber") int userNumber) throws Exception{
    ...
    public ModelAndView addCart(HttpSession session, Cart cart) throws Exception{
        ModelAndView mv = new ModelAndView("redirect:http://localhost:8080/ojhmall/product/prdView.do?prdNum="+cart.getPrdNumber());
